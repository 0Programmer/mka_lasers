...
| destroyOnPropHit                     | Boolean  | false                                                                              | false    | Destroy the LaserWrapper when the visible prop gets destroyed (you need to recreate the laser when destroyed)                                                                                                                                                                                                                                                            |
...
- `laser.OnPlayerHit(function(playerBeingHit, hitPos) end)`     -- detect laser hit on player
- `laser.ClearOnPlayerHit()`     -- delete the OnPlayerHit function
